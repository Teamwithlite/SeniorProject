...
export default function CodeTestPage() {
  ...
  // Check system/user theme preference on load
  useEffect(() => {
...
.eSFFfM { display: inline-flex; -webkit-box-align: center; align-items: center; -webkit-box-pack: center; justify-content: center; user-select: none; border-radius: var(--border-radius-medium); height: var(--button-size-default); width: var(--button-size-default); background-color: var(--color-background-button-text-default); color: var(--color-fill-button-icon); }</style></div>`;
  ...
  const getCustomCssVariables = () => {
    return `
      :root {
        ...
        --color-background-button-text-default: ${isDarkMode ? '#3a3a3d' : '#333333'};
        --color-text-button-text: ${isDarkMode ? '#efeff1' : '#ffffff'};
        --border-radius-medium: 4px;
        --color-fill-button-icon: ${isDarkMode ? '#efeff1' : '#ffffff'};
      }
      body { 
  ...
  return (
    <div className="container mx-auto p-6">
      <Card className="max-w-6xl mx-auto dark:bg-gray-800 dark:border-gray-700">
        <CardHeader className="flex flex-row items-center justify-between dark:bg-gray-800 dark:text-gray-100">
        ...
        <CardContent className="dark:bg-gray-800">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div className="flex flex-col h-full">
              <div className="flex justify-between items-center mb-2">
                <h2 className="text-lg font-semibold dark:text-gray-200">Edit Code</h2>
                <div className="flex gap-2">
                  <Button 
                  ...
                  <Button 
                    ...
                    variant="outline"
                    size="sm"
                    className="dark:border-gray-600 dark:text-gray-200 text-gray-800"
                  >
              ...
              <textarea
                ref={codeEditorRef}
                className="w-full h-96 p-4 font-mono text-sm border border-gray-300 rounded dark:bg-gray-900 dark:border-gray-700 dark:text-gray-200"
                value={editedCode}
            ...
            <div className="flex flex-col h-full">
              <div className="flex justify-between items-center mb-2">
                <h2 className="text-lg font-semibold dark:text-gray-200">Preview</h2>
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className={isFullScreen ? '' : 'dark:border-gray-600 dark:text-gray-200 text-gray-800'}
                  >
              ...
              <div className="flex gap-2 mb-4">
                <Button 
                  ...
                  className={selectedPreset !== 'mobile' ? 'dark:border-gray-600 dark:text-gray-200 text-gray-800' : ''}
                >
                ...
                <Button 
                  ...
                  className={selectedPreset !== 'tablet' ? 'dark:border-gray-600 dark:text-gray-200 text-gray-800' : ''}
                >
                ...
                <Button 
                  ...
                  className={selectedPreset !== 'desktop' ? 'dark:border-gray-600 dark:text-gray-200 text-gray-800' : ''}
                >
                ...
                <Button 
                  ...
                  className={selectedPreset !== 'custom' ? 'dark:border-gray-600 dark:text-gray-200 text-gray-800' : ''}
                >
                  Custom
                </Button>
              </div>
              ...
              {selectedPreset === 'custom' && (
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div>
                    <Label htmlFor="width" className="dark:text-gray-200">Width (px)</Label>
                    <Input
                      id="width"
                      type="number"
                      value={previewWidth}
                  ...
                  <div>
                    <Label htmlFor="height" className="dark:text-gray-200">Height (px)</Label>
                    <Input
                      id="height"
                      type="number"
                      value={previewHeight}
              ...
              <div 
                className={`bg-gray-100 dark:bg-gray-900 rounded border border-gray-300 dark:border-gray-700 flex items-center justify-center p-4 ${
                  isFullScreen ? 'h-96' : ''}`}
                style={{ 
              ...
              <div className="mt-4 flex justify-between items-center">
                <Badge variant={showEditedPreview ? "default" : "outline"} className={showEditedPreview ? "" : "dark:bg-gray-700 dark:text-gray-200 text-gray-800 border border-gray-300"}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h2 className="text-lg font-semibold mb-4 dark:text-gray-200">How to Use This Tool</h2>
              <ol className="list-decimal ml-5 space-y-2 dark:text-gray-300">
            ...
            <div>
              <h2 className="text-lg font-semibold mb-4 dark:text-gray-200">Troubleshooting Tips</h2>
              <ul className="list-disc ml-5 space-y-2 dark:text-gray-300">
